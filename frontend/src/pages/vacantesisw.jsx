...
const ContenidoTabla = (
    <div className='contenidoVacantes'>
      ...
      <tr className='segundaColumna'>
        ...
        <td>Contacto: 4 horas.<br/>
            Corrección: 7 horas.<br/>
            Laboratorio: 4 horas.<br/><br/>
            Total: 15 horas.
        </td>
        <td className='tareas'>
            <ul>
                <li>Apoyar durante evaluaciones.</li>
                <li>Ayudantias de catedra.</li>
                <li>Apoyo en tareas de desarrollo.</li>
            </ul>
        </td>
  ...
  return (
    <div className='page'>
      ...
      <div className='container'>
        <Carta titulo="Vacantes INF-225 - Ingenieria de Software" contenido={ContenidoTabla}/>
        <Footer/>
      </div>
    </div>
  )
